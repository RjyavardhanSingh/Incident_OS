...
INVESTIGATION_TRANSITIONS: dict[str, set[str]] = {
    ...
    INVESTIGATION_STATUS_ANALYZING: {INVESTIGATION_STATUS_VERIFYING},
    INVESTIGATION_STATUS_VERIFYING: {INVESTIGATION_STATUS_READY, INVESTIGATION_STATUS_FAILED},
    INVESTIGATION_STATUS_READY: set(),
